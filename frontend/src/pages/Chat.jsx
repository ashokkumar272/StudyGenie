        ...
        >          {/* Main chat area */}
          <div
            className={`flex flex-col relative min-w-0 ${
              isPanelOpen 
                ? "flex-none w-1/2 max-w-1/2 overflow-hidden lg:flex lg:w-full lg:max-w-full lg:flex-1 md:hidden" 
                : "flex-1 items-center w-full max-w-full lg:w-full lg:max-w-full lg:flex-1"
            }`}
          >
            {" "}            {/* Chat container - scrollable */}
            <div
              className={`flex-1 overflow-auto chat-content-area bg-white rounded-lg shadow-sm transition-all duration-200 hover:shadow-md w-full max-w-full sm:mx-2 lg:mx-2 ${
                !isPanelOpen ? "lg:w-[70%] lg:max-w-[70%]" : ""
              }`}
            >
              {messages.length === 0 ? (
            ...
            <div className="p-3 lg:p-4 sticky bottom-0 z-10 mt-auto w-full max-w-full lg:w-[70%] lg:max-w-[70%]">
